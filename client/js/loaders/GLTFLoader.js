...
var GLTFLoader = (function () {
	...
	/**
	 * Unlit THREE.Materials Extension
	 *
	...
	/**
	 * Clearcoat THREE.Materials Extension
	 *
	...
	/**
	 * Transmission THREE.Materials Extension
	 *
	...
	*/
	 ...
	 * be marked. Non-scenegraph resources (like THREE.Materials, Geometries, and
	...
	GLTFParser.prototype.assignTexture = function (materialParams, mapName, mapDef) {
		...
		return this.getDependency('texture', mapDef.index).then(function (texture) {
			// THREE.Materials sample aoMap from UV set 1 and other maps from UV set 0 - this can't be configured
	...
	GLTFParser.prototype.loadCamera = function (cameraIndex) {
		...
		if (cameraDef.type === 'perspective') {
			camera = new THREE.PerspectiveCamera(MathUtils.radToDeg(params.yfov), params.aspectRatio || 1, params.znear || 1, params.zfar || 2e6);
			...
			for (var i = 0, il = nodes.length; i < il; i ++) {
				...
				for (var j = 0, jl = targetNames.length; j < jl; j ++) {
					...
					if (sampler.interpolation === 'CUBICSPLINE') {
						track.createInterpolant = function THREE.InterpolantFactoryMethodGLTFCubicSpline(result) {
