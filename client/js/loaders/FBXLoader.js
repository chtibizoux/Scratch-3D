...
var FBXLoader = (function () {
				...
				children.forEach(function (child) {
					if (child.relationship === 'LookAtProperty') {
						...
						if ('Lcl_Translation' in lookAtTarget) {
							...
							} else {// Cameras and other THREE.Object3Ds
	...
	GeometryParser.prototype = {
		...
		// Parse Vertex THREE.Colors from FBXTree.Objects.Geometry.LayerElementColor if it exists
		parseVertexColors: function (ColorNode) {
			var mappingType = THREE.ColorNode.MappingInformationType;
			var referenceType = THREE.ColorNode.ReferenceInformationType;
			var buffer = THREE.ColorNode.Colors.a;
			var indexBuffer = [];
			if (referenceType === 'IndexToDirect') {
				indexBuffer = THREE.ColorNode.ColorIndex.a;
			}
			return {
				dataSize: 4,
				buffer: buffer,
		...
		parseProperty: function (reader) {
			...
			switch (type) {
				...
				case 'l':
					...
					if (typeof THREE.Inflate === 'undefined') {
						console.error('THREE.FBXLoader: External library THREE.Inflate.min.js required, obtain or import from https://github.com/imaya/zlib.js');
					}
					var inflate = new THREE.Inflate(new Uint8Array(reader.getArrayBuffer(compressedLength))); // eslint-disable-line no-undef
