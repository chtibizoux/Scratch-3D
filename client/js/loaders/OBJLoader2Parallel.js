...
OBJLoader2Parallel.prototype = Object.assign(Object.create(OBJLoader2.prototype), {
	...
	/**
	 * Allow to get hold of {@link THREE.WorkerExecutionSupport} for configuration purposes.
	...
	buildWorkerCode: function () {
		const codeBuilderInstructions = new THREE.CodeBuilderInstructions(true, true, this.preferJsmWorker);
