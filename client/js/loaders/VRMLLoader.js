...
var VRMLLoader = (function () {
	// dependency check
	if (typeof THREE.chevrotain === 'undefined') {// eslint-disable-line no-undef
		throw Error('THREE.VRMLLoader: External library THREE.chevrotain.min.js required.');
	}
	// class definitions
	...
	VRMLLoader.prototype = Object.assign(Object.create(Loader.prototype), {
		...
		parse: function (data, path) {
			...
			function createTokens() {
				var createToken = THREE.chevrotain.createToken; // eslint-disable-line no-undef
				...
				var Comment = createToken({
					name: 'Comment',
					pattern: /#.*/,
					group: THREE.chevrotain.Lexer.SKIPPED // eslint-disable-line no-undef
				});
	...
	function VRMLLexer(tokens) {
		this.lexer = new THREE.chevrotain.Lexer(tokens); // eslint-disable-line no-undef
	}
	VRMLLexer.prototype = {
